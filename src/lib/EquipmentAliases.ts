...
const equipmentAliases = {
  ...
  8901: [8919, 8901, 8917, 8915, 8913, 8911, 8909, 8907, 8905, 8903, 8921], // Black mask#(10)
  11774: [11783, 25275, 26780, 11774, 25266, 26771, 11782, 25274, 26779, 11781, 25273, 26778, 11780, 25272, 26777, 11779, 25271, 26776, 11778, 25270, 26775, 11777, 25269, 26774, 11776, 25268, 26773, 11775, 25267, 26772, 11784, 25276, 26781], // Black mask (i)#(10)
